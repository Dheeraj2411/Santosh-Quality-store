              ...
              <td class="py-3 px-4">
                <div class="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div v-if="product.is_featured" class="text-xs text-amber-600 font-medium">⭐ Featured</div>
                  </div>
                </div>
              </td>
...
function doSearch() {
  clearTimeout(timer)
  timer = setTimeout(() => router.get('/admin/products', { search: searchQuery.value }, { preserveScroll: true, replace: true }), 400)
}
